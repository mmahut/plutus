...
tests =
    ...
    testGroup "vesting"
    [ checkPredicate defaultCheckOptions "secure some funds with the vesting script"
    ...
    , checkPredicate defaultCheckOptions "retrieve some funds"
        (walletFundsChange w2 (Numeric.negate $ totalAmount vesting)
        .&&. assertNoFailedTransactions
        .&&. walletFundsChange w1 (Ada.lovelaceValueOf 10))
        retrieveFundsTrace

    , checkPredicate defaultCheckOptions "cannot retrieve more than allowed"
    ...
    , checkPredicate defaultCheckOptions "can retrieve everything at the end"
